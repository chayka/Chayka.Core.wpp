...
angular.module('chayka-pagination', ['chayka-nls', 'chayka-utils'])
    .directive('pagination', ['utils', (utils) => {
        ...
        return {
            ...
            controller: ($scope) => {
                 ...
                 * @returns {*}
                 */
                $scope.setCurrentPage = (val, render) => {
                 ...
                 * @returns {*}
                 */
                $scope.setTotalPages = (val, render) => {
                 ...
                 * @returns {*}
                 */
                $scope.setHrefTemplate = (val, render) => {
                ...
                $scope.getItems = () => {
                     ...
                     *  ['previous', 'first', 'rewind', 'pages', 'forward', 'last', 'next'];
                     */
                    $scope.order.split(/\s+/).forEach((item) => {
                        switch(item){
                            case 'previous':
