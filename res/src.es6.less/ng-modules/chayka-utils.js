...
angular.module('chayka-utils', [])
    .factory('utils', ['$window', '$timeout', '$compile', function($window, $timeout, $compile){
        ...
        Chayka.Utils = Chayka.Utils ||
        {
             ...
             * @returns {*}
             */
            declare: (classname, parent, implementation) => {
             ...
             * @param {{}} defaults
             */
            setObjectDefaults: (obj, defaults) => {
                obj = obj || {};
             ...
             * @return {*}
             */
            getHtmlParam: ($element, name, defaultValue) => {
             ...
             */
            template: (tpl, params) => {
                return tpl.replace(/{([^}]+)}/g, (all, param) => {
             ...
             */
            recursiveDirectiveCompile: (element, link) => {
     ...
     */
    .directive('wpInclude', ['utils', (utils) => {
        return {
            restrict: 'AE',
